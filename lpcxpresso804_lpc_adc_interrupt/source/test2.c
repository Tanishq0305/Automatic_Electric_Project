...
//	 PRINTF("val4: %u\r\n",val4);
	 uint32_t val11 = val1/256;
	 uint32_t val22 = val2/256;
	 uint32_t val33 = val3/256;
	 uint32_t val44 = val4/233;

//	PRINTF("avg4: %u\r\n",val44);
	uint32_t avg = (val11+val22+val33+val44)/4;
//	PRINTF("Average: %u\r\n",avg);
	uint32_t squarert = sqrt(avg);
//	PRINTF("squarert: %u\r\n",squarert);
