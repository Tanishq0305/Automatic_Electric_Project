...
//
//
////int rmsCalculation(long long arr[4]){
////
...
////}
//
//double rmsCalculation(int val1, int val2, int val3, int val4) {
////    double sum = 0.0;
////    for (int i = 0; i < 4; ++i) {
////        sum += arr[i];
////    }
...
////        	double rmsResult = rmsCalculation(arr);
//        	PRINTF("val1: %d\r\n",val1);
//        	PRINTF("val2: %d\r\n",val2);
//        	PRINTF("val3: %d\r\n",val3);
//        	PRINTF("val4: %d\r\n",val4);
////        rmsCalculation(val1, val2, val3, val4);
//        	unsigned int avg55 = 4292870400;
//        	float calc = 4292870400/255;
